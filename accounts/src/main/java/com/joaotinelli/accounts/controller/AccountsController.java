...
import com.joaotinelli.accounts.dto.AccountsContactInfoDto;
import com.joaotinelli.accounts.dto.CustomerDto;
import com.joaotinelli.accounts.dto.ErrorResponseDto;
...
@Tag(
        name = "CRUD REST APIs for Accounts in JoaoBank",
        description = "CRUD REST APIs in JoaoBank to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
...
public class AccountsController {
    ...
    @Autowired
    private Environment environment; // package: org.springframework.core.env.Environment;
    ...
    @Operation(
            ...
            description = "REST API to create new Customer & Account inside JoaoBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    @Operation(
            ...
            description = "REST API to delete Customer &  ccount details based on a mobile number"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
